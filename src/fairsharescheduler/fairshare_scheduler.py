...
class FairShareScheduler(driver.Scheduler):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.faireShareManager = FairShareManager(mysqlHost=CONF.mysql_host, mysqlUser=CONF.mysql_user, mysqlPasswd=CONF.mysql_passwd, numOfPeriods=CONF.num_of_periods, periodLength=CONF.period_length, defaultProjectShare=CONF.default_project_share, projectShares=projectShares, userShares=userShares, decayWeight=CONF.decay_weight)
